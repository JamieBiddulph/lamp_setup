...
sed -ie 's/2M/500M/g' /etc/php/7.1/apache2/php.ini
#set max_execution to 60 seconds
sed -ie 's/30/60/g' /etc/php/7.1/apache2/php.ini
#set memory_limit to 128M
sed -ie 's/12500/128/g' /etc/php/7.1/apache2/php.ini
#set opcache revalidate frequencey to 60
sed -ie 's/;opcache.revalidate_freq=2/opcache.revalidate_freq=60/g' /etc/php/7.1/apache2/php.ini
#starting apache2
...
echo "#!/bin/bash
/usr/bin/php7.1 /var/www/html/admin/cli/cron.php" > /var/www/cron.sh
